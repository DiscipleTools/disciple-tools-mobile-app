  ...
  return(
    <>
      <View style={styles.container}>
        ...
        <GridItem top={0+10} left={150} icon={sharingIcon} selected={isSelected(ChurchHealthConstants.SHARING)} />
        <GridItem top={0+10} left={180} />
        <GridItem top={0+10} left={240} />
        <GridItem top={0+10} left={300} />

        <GridItem top={60-5} left={0} />
        <GridItem top={60-5} left={60} icon={praiseIcon} selected={isSelected(ChurchHealthConstants.PRAISE)} />
        <GridItem top={60-5} left={120} />
        <GridItem top={60-5} left={180} />
        <GridItem top={60-5} left={240} icon={leadersIcon} selected={isSelected(ChurchHealthConstants.LEADERS)} />
        <GridItem top={60-5} left={300} />

        <GridItem top={120-5} left={0+25} icon={prayerIcon} selected={isSelected(ChurchHealthConstants.PRAYER)} />
        ...
        <GridItem top={240} left={60+10} icon={fellowshipIcon} selected={isSelected(ChurchHealthConstants.FELLOWSHIP)} />
        <GridItem top={240} left={120} />
        <GridItem top={240} left={180} />
        <GridItem top={240} left={240-20} icon={bibleStudyIcon} selected={isSelected(ChurchHealthConstants.BIBLE)} />
        <GridItem top={240} left={300} />

        <GridItem top={300} left={0} />
        <GridItem top={300} left={60} />
        <GridItem top={300} left={120} />
        <GridItem top={300-20} left={180-30} icon={communionIcon} selected={isSelected(ChurchHealthConstants.COMMUNION)} />
