  ...
  return (
    <View
      ...
      <View style={[styles.listItemContainer, { borderTopWidth: 0 }]}>
        <Text>Usage: <Text style={{ fontWeight: "bold" }}>{sizeOfCache}</Text></Text>
      </View>
      ...
      <View style={styles.buttonDescriptionContainer}>
        <Text style={styles.buttonDescriptionText}>
          This action will trigger the app to fetch and storage all possible data (including all contacts, groups, their associated comments, locations, people groups, etc...). Depending on your team's usage, this may be several MBs of data and cause the app to run sluggishly. (By default, we download only favorites and their associated data.  Any other data *accessed* while online is also storaged and available for offline use, unless deleted).
        </Text>
      </View>
      <View style={styles.listItemContainer}>
        <DangerButton
      ...
      <View style={styles.buttonDescriptionContainer}>
        <Text style={styles.buttonDescriptionText}>
          Warning! If you are OFFLINE and you clear storage, then you will not be able to access your data until you are back online and it is refreshed.
        </Text>
      </View>
    </View>
  );
