...
export const GROUPS_GET_USERS_CONTACTS_START =
  "GROUPS_GET_USERS_CONTACTS_START";
export const GROUPS_GET_USERS_CONTACTS_SUCCESS =
  "GROUPS_GET_USERS_CONTACTS_SUCCESS";
export const GROUPS_GET_USERS_CONTACTS_RESPONSE =
  "GROUPS_GET_USERS_CONTACTS_RESPONSE";
export const GROUPS_GET_USERS_CONTACTS_FAILURE =
  "GROUPS_GET_USERS_CONTACTS_FAILURE";
...
export const GROUPS_GET_PEOPLE_GROUPS_SUCCESS =
  "GROUPS_GET_PEOPLE_GROUPS_SUCCESS";
export const GROUPS_GET_PEOPLE_GROUPS_RESPONSE =
  "GROUPS_GET_PEOPLE_GROUPS_RESPONSE";
export const GROUPS_GET_PEOPLE_GROUPS_FAILURE =
  "GROUPS_GET_PEOPLE_GROUPS_FAILURE";
