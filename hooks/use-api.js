...
const useAPI = ({ cacheKey }={}) => {
  ...
  */
  ...
  const markAllNotificationsViewed = async({ userId }) => markNotifications({ action: "mark_all_viewed", id: userId });
  const markNotificationViewed = async({ notificationId }) => markNotifications({ action: "mark_viewed", id: notificationId });
  const markNotificationUnread = async({ notificationId }) => markNotifications({ action: "mark_unread", id: notificationId });
